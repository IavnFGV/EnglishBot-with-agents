...
- legacy commands such as invite/join/admin/granttopic/workbook are now blocked at runtime for family users, so they no longer act as real entry points in the family-first product path.
