...
- Learner-facing training and homework buttons now use more child-friendly emoji labels on the active runtime path, while bot-facing text still stays centralized in `englishbot/i18n.py`.
